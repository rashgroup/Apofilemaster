...
import static org.telegram.messenger.AndroidUtilities.formatFileSize;
import static org.telegram.messenger.AndroidUtilities.getMinTabletSide;
import static org.telegram.messenger.AndroidUtilities.getPhotoSize;
...
public class ChatMessageCell extends BaseCell implements SeekBar.SeekBarDelegate, ImageReceiver.ImageReceiverDelegate, MediaController.FileDownloadProgressListener {
    ...
    public ChatMessageCell(Context context) {
        ...
        if (infoPaint == null) {
            ...
            infoPaint.setTypeface(getTypeface("fonts/rmedium.ttf"));
            ...
            docBackPaint.setTypeface(getTypeface("fonts/rmedium.ttf"));

            deleteProgressPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
            deleteProgressPaint.setColor(Theme.MSG_SECRET_TIME_TEXT_COLOR);
            deleteProgressPaint.setTypeface(getTypeface("fonts/rmedium.ttf"));
            ...
            botProgressPaint.setTypeface(getTypeface("fonts/rmedium.ttf"));
            ...
            urlPaint.setTypeface(getTypeface("fonts/rmedium.ttf"));

            urlSelectionPaint = new Paint();
            urlSelectionPaint.setColor(Theme.MSG_TEXT_SELECT_BACKGROUND_COLOR);
            urlSelectionPaint.setTypeface(getTypeface("fonts/rmedium.ttf"));

            audioTimePaint = new TextPaint(TextPaint.ANTI_ALIAS_FLAG);
            audioTimePaint.setTypeface(getTypeface("fonts/rmedium.ttf"));
            ...
            audioPerformerPaint.setTypeface(getTypeface("fonts/rmedium.ttf"));
            ...
            contactPhonePaint.setTypeface(getTypeface("fonts/rmedium.ttf"));

            durationPaint = new TextPaint(Paint.ANTI_ALIAS_FLAG);
            durationPaint.setColor(Theme.MSG_WEB_PREVIEW_DURATION_TEXT_COLOR);
            durationPaint.setTypeface(getTypeface("fonts/rmedium.ttf"));
            ...
            forwardNamePaint.setTypeface(getTypeface("fonts/rmedium.ttf"));
            ...
            replyTextPaint.setTypeface(getTypeface("fonts/rmedium.ttf"));
