...
public class PlusSettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private class ListAdapter extends BaseFragmentAdapter {
        ...
        public boolean isEnabled(int i) {
            return i == showAndroidEmojiRow || i == useDeviceFontRow || i== setspecificFont || i== reportHelp || i == emojiPopupSize || i == dialogsTabsHeightRow || i == dialogsTabsRow || i == chatShowDirectShareBtn || i == profileSharedOptionsRow ||
                    ...
                    i == keepOriginalFilenameRow || i == dialogsPicClickRow || i == dialogsGroupPicClickRow || i == hideMobileNumberRow || i == hideGhostModeRow || i == hideLockRow || i == showUsernameRow ||
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
                ...
                if (i == dialogsTabsRow) {
                    ...
                    textCell.setMultilineDetail(true);
                    textCell.setTextAndValue(LocaleController.getString("ReportProblemHelp", R.string.ReportProblemHelp) ,"", true);
        ...
        public int getItemViewType(int i) {
            ...
            if (i == settingsSectionRow || i == messagesSectionRow || i == profileSectionRow || i == drawerSectionRow || i == privacySectionRow ||
                ...
                return 1;
                    ...
                    i == keepOriginalFilenameRow || i == hideMobileNumberRow || i == hideGhostModeRow || i == hideLockRow|| i == showUsernameRow || i == chatDirectShareToMenu || i == chatDirectShareReplies || i == chatDirectShareFavsFirst ||
                ...
                return 2;
            } else if (i == dialogsTabsRow || i == chatShowDirectShareBtn || i == profileSharedOptionsRow || i == savePlusSettingsRow || i == setspecificFont || i== reportHelp ||
