...
public class BaseFragment {
    ...
    protected ActionBar createActionBar(Context context) {
        ...
        actionBar.setBackgroundResource(R.color.header); //Telegram
        return actionBar;
    }
    ...
    protected AnimatorSetProxy onCustomTransitionAnimation2(boolean isOpen, final Runnable callback) {
        return null;
    }
...
//            dialog.getWindow().setBackgroundDrawableResource(android.R.color.background_dark);
    ...
    class Dismis implements DialogInterface.OnDismissListener {
        Dismis() {
        }
